    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-lg shadow divide-y">
          {items.map((item) => (
            <div key={item.id} className="flex items-center gap-3 p-3 sm:p-4">
              ...
              <p className="font-bold text-sm min-w-[70px] text-right flex-shrink-0">
        ...
        <div className="mt-4 flex flex-col sm:flex-row gap-3">
          <Link
            href="/"
            className="flex-1 text-center border border-fuchsia text-fuchsia px-6 py-3 rounded-lg font-semibold hover:bg-fuchsia/5 transition-colors min-h-[48px] flex items-center justify-center"
          >
            Continue Shopping
          </Link>
          <Link
            href="/checkout"
            className="flex-1 text-center bg-fuchsia text-white px-6 py-3 rounded-lg font-semibold hover:bg-fuchsia-dark transition-colors min-h-[48px] flex items-center justify-center"
          >
            Proceed to Checkout
          </Link>
        </div>
